        ...
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    ...
                    <a href="<?php echo base_url();?>formcontroller/principal" class="nav_link active1"> 
                  ...
                  <?php $i = 1; foreach($applications as $applications): ?>
                    <tr>
                        ...
                        <?php if($applications->status == '0'): ?>
                            <a class="text-info" style="margin-right: 10px;padding: 10px;font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetails/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i>View Form</a>
                        <?php elseif($applications->status == '4'):?>
                            <a class="text-info" style="font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetails/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i></a>
