...
<body>
    <?php foreach ($view->result() as $row) : ?>
        ...
        <div class="mt-4 pb-4 d-grid gap-2 d-md-flex justify-content-center mb-4">
            <?php if ($row->status == '2') : ?>
                <a class="btn btn-success" style="width:125px;" type="button" href="<?= base_url('formcontroller/updatejd/' . $row->Id . '/' . $row->Email); ?>">Approve</a>
            ...
            <?php else : ?>
                ...
                <a class="btn btn-danger" style="width:125px;" type="button" href="<?= base_url('formcontroller/revertJd/' . $row->Id); ?>">Revert</a>
            <?php endif ?>
        </div>
        ...
        <div class="modal fade" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
            <div class="modal-dialog">
                <div class="modal-content">
                    <?= form_open('formcontroller/jdreject/' . $row->Id); ?>
