    ...
    <?php foreach ($view->result() as $row) : ?>
        ...
        <div class="container mt-4 d-grid gap-2 d-md-flex justify-content-center mb-4">
            ...
            <?php else : ?>
                ...
                <a class="btn btn-danger" style="width:125px;" type="button" href="<?= base_url('formcontroller/revertPrincipal/' . $row->Id) ?>">Revert</a>
            <?php endif ?>
        </div>
        ...
        <div class="modal2" id="modal2">
            <div class="modal-content2">
                <?= form_open('formcontroller/principalreject/' . $row->Id); ?>
