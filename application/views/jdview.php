        ...
        <nav class="nav">
            <div> 
                ...
                <div class="nav_list"> 
                    ...
                    <a href="<?php echo base_url();?>formcontroller/jd" class="nav_link active1"> 
            ...
            <div class="tab-pane active" id="Cas_Applications">
                ...
                <table class="table table-bordered">
                  ...
                  <?php $i = 1; foreach($applications as $applications): ?>
                    <?php if($applications->status == '2' || $applications->status == '3' || $applications->status == '6'): ?>
                    <tr>
                        ...
                        <?php if($applications->status == '2'): ?>
                            <a class="text-info" style="margin-right: 10px;padding: 10px;font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetailsjd/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i>View Form</a>

                        <?php elseif($applications->status == '6'):?>
                            <a class="text-info" style="font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetailsjd/'.$applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i></a>
