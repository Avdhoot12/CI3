                            ...
                            <table class="table table-bordered">
                                ...
                                <tbody>
                                    ...
                                    foreach ($applications as $applications) : ?>
                                        <?php if ($applications->status == '1' || $applications->status == '2' ||  $applications->status == '3' || $applications->status == '5' || $applications->status == '6') : ?>
                                            <tr>
                                                ...
                                                <td class="text-center align-middle">
                                                    ...
                                                    <?php if ($applications->status == '1') : ?>
                                                        <a class="text-info" style="margin-right: 10px;padding: 10px;font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetailsdto/' . $applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i>View Form</a>

                                                    <?php elseif ($applications->status == '5') : ?>
                                                        <a class="text-info" style="font-size: 18px;text-decoration: none;" id="view_form" href="<?= base_url('formcontroller/viewDetailsdto/' . $applications->Id) ?>" id="view_form"><i class="fa fa-eye" style="margin-right: 10px;" aria-hidden="true"></i></a>
